...
if(isset($_SESSION['username'])){
    ...
    $result3 = mysqli_query($conn,("Select * from users where md5(username)='$username'")) or die("Failed to Retrive Database");
    ...
    <div>
        ...
        <div class="dropshadow1 roundbox1" style="margin: 50px;">
            ...
            <form  id="ajaxform" class="ajax-form" method="post">
                ...
                <input type="hidden" name="bookedby" id="bookedby" value="'.$user.'" readonly required><br>';
                }
                else{
                    echo '<label for="Username">Username: </label>
                <input type="text" name="username" id="username" value="'.$user.'" readonly required>
                <input type="hidden" name="bookedby" id="bookedby" value="self" readonly required><br><br>';
                }
                ?>
                <label for="From Date">From (12:00 PM): </label>
                <input type="date" name="fromdate" id="fromdate" required><br>
                <label for="To Date">To (12:00 PM): </label>
                <input type="date" name="todate" id="todate" required><br>

                <br><br>
                <input type="submit" value="Book" name="submit" id="submit" class="button1"><br>
            </form>
